    ...
    <div className="calculator">
      ...
      <div className="calculator-keypad">
        <div className="keys-function">
          <CalculatorKey keyValue={"c"} className={'red'} onClick={handleOperation} />
          <CalculatorKey keyValue={"\xB1"} className={'black'} onClick={handleOperation} />
          <CalculatorKey keyValue={"%"} className={'black'} onClick={handleOperation} />
        </div>
        <div className="keys-operators">
          ...
          <CalculatorKey keyValue={"*"} className={'black'} onClick={handleOperation} />
          <CalculatorKey keyValue={"/"} className={'black'} onClick={handleOperation} />
          <CalculatorKey keyValue={"="} className={'green'} onClick={handleOperation} />
        </div>
